        ...
        <div class="md-layout-item md-small-size-100">
            <form>
                ...
                <md-card-header class="md-card-header-icon md-card-header-primary">
                    ...
                    <h4 class="title">Registrar lugar</h4>
                </md-card-header>
...
import { CREATE_VENUE } from '../../../../plugins/graphql';
...
export default {
  ...
  data() {
    return {
      zoom: 16,
      //Coordenadas de la vicerrectoría de cultura y bienestar
    ...
    validate() {
      this.$validator.validateAll().then(isValid => {
        if(isValid)
        {
            ...
            this.notifyVue('top','right','success','Lugar creado correctamente');
