          ...
          <div class="md-collapse" :class="{'off-canvas-sidebar': responsive}">
            <md-list>
              <md-list-item to="/lock" @click="linkClick">
                <md-icon>world</md-icon>
                Sitio web de la Vicerrectoría de Cultura y Bienestar
              </md-list-item>
            </md-list>
          </div>
        </div> -->
        ...
        <footer class="footer">
          <div class="container md-offset">
              <div class="copyright text-center">
                &copy; {{ new Date().getFullYear() }} <a href="https://unicauca.edu.co" target="_blank">Vicerrectoría de Cultura y Bienestar - Universidad del Cauca</a>
              </div>
          </div>
        </footer>
      </div>
  ...
  computed: {
    setBgImage() {
      let images = {
        ...
        Login: "./img/bg_casa_mosquera.jpg",
